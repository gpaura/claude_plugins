...
`https://github.com/gpaura/claude_plugins`
...
4. **Test Installation** - `/plugin install gpaura-claude-code@gpaura-claude-code`
...
/plugin enable gpaura-claude-code@gpaura-claude-code
```
